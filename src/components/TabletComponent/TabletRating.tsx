        ...
        <ContainerBox>
            ...
            <RowStart>
                ...
                <Contain>
                    ...
                    <RowDiv>
                        <SubDiv> <Paragraph text={'Excellent'} fontSize={GlobalStyle.size.size10} fontWeight='600' /></SubDiv>

                        <ProgressDiv>
                            <Progress percent={excellent?.length} showInfo={false} size="small" />
                        </ProgressDiv>
                        <SubDiv2>
                            <Paragraph text={excellent?.length} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv2>

                    </RowDiv>
                    <RowDiv>
                        <SubDiv>
                            <Paragraph text={'Very good'} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv>
                        ...
                        <SubDiv2>
                            <Paragraph text={good?.length} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv2>

                    </RowDiv>
                    <RowDiv>
                        <SubDiv>
                            <Paragraph text={'Average'} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv>
                        ...
                        <SubDiv2>
                            <Paragraph text={average?.length} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv2>

                    </RowDiv>
                    <RowDiv>
                        <SubDiv>
                            <Paragraph text={'Poor'} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv>
                        ...
                        <SubDiv2>
                            <Paragraph text={poor?.length} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv2>

                    </RowDiv>
                    <RowDiv>
                        <SubDiv>
                            <Paragraph text={'Terrible'} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv>
                        ...
                        <SubDiv2>
                            <Paragraph text={terrible?.length} fontSize={GlobalStyle.size.size10} fontWeight='600' />
                        </SubDiv2>
