  ...
  return (
    <Container>
      ...
      <RowStart>
        <Div>
          <RowBetween>
            <Paragraph text="Does your product have sizes?" fontSize={GlobalStyle.size.size11} fontWeight='400' />
            {
        ...
        <Div>
          <RowBetween>
            <Paragraph text="Does your product have colours?" fontSize={GlobalStyle.size.size11} fontWeight='400' />
            {
...
export default TabletAddProduct
