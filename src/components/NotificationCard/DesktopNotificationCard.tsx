...
const DesktopNotificationCard: React.FC<NotificationCardType> = ({ icon, header, duration,action }) => {
    ...
    return (
        <RowBetween>
            ...
            <RowStart onClick={() => handleRoute(action)} style={{cursor: 'pointer'}}>
...
export default DesktopNotificationCard
